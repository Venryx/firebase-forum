(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("js-vextensions"), require("redux"), require("react-redux"), require("react-vextensions"), require("react"), require("react-vcomponents"), require("react-dom"), require("react-vmessagebox"));
	else if(typeof define === 'function' && define.amd)
		define(["js-vextensions", "redux", "react-redux", "react-vextensions", "react", "react-vcomponents", "react-dom", "react-vmessagebox"], factory);
	else {
		var a = typeof exports === 'object' ? factory(require("js-vextensions"), require("redux"), require("react-redux"), require("react-vextensions"), require("react"), require("react-vcomponents"), require("react-dom"), require("react-vmessagebox")) : factory(root["js-vextensions"], root["redux"], root["react-redux"], root["react-vextensions"], root["react"], root["react-vcomponents"], root["react-dom"], root["react-vmessagebox"]);
		for(var i in a) (typeof exports === 'object' ? exports : root)[i] = a[i];
	}
})(this, function(__WEBPACK_EXTERNAL_MODULE_5__, __WEBPACK_EXTERNAL_MODULE_8__, __WEBPACK_EXTERNAL_MODULE_15__, __WEBPACK_EXTERNAL_MODULE_16__, __WEBPACK_EXTERNAL_MODULE_174__, __WEBPACK_EXTERNAL_MODULE_175__, __WEBPACK_EXTERNAL_MODULE_178__, __WEBPACK_EXTERNAL_MODULE_187__) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _forum = __webpack_require__(6);
	...
	var _forum2 = __webpack_require__(9);
	...
	var _Section = __webpack_require__(170);
	...
	var _Subforum = __webpack_require__(171);
	...
	var _Thread = __webpack_require__(172);
	...
	var _Forum = __webpack_require__(173);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var LogTypes = exports.LogTypes = function LogTypes() {
	    _classCallCheck(this, LogTypes);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.IsUserBasicOrAnon = IsUserBasicOrAnon;
	exports.IsUserCreatorOrMod = IsUserCreatorOrMod;
	...
	function State() {
	    ...
	    if (args.length == 0) return store.getState();else if (typeof args[0] == "function") pathSegments = ConvertPathGetterFuncToPropChain(args[0]);else if (typeof args[0] == "string") pathSegments = args;else {
	        ;
	    ...
	    var selectedData = (0, _jsVextensions.DeepGet)(store.getState(), _Manager.Manager.rootStorePath + "/" + pathSegments.join("/"));
	    return selectedData;
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.ForumReducer = exports.Forum = exports.ACTThreadSelect = exports.ACTSubforumSelect = undefined;
	exports.GetSelectedSubforumID = GetSelectedSubforumID;
	exports.GetSelectedSubforum = GetSelectedSubforum;
	exports.GetSelectedThreadID = GetSelectedThreadID;
	exports.GetSelectedThread = GetSelectedThread;

	var _Action3 = __webpack_require__(7);

	var _redux = __webpack_require__(8);

	var _forum = __webpack_require__(9);
	...
	var ACTSubforumSelect = exports.ACTSubforumSelect = function (_Action) {
	    _inherits(ACTSubforumSelect, _Action);

	    function ACTSubforumSelect() {
	        _classCallCheck(this, ACTSubforumSelect);

	        return _possibleConstructorReturn(this, (ACTSubforumSelect.__proto__ || Object.getPrototypeOf(ACTSubforumSelect)).apply(this, arguments));
	    }
	...
	var ACTThreadSelect = exports.ACTThreadSelect = function (_Action2) {
	    ...
	    function ACTThreadSelect() {
	        _classCallCheck(this, ACTThreadSelect);

	        return _possibleConstructorReturn(this, (ACTThreadSelect.__proto__ || Object.getPrototypeOf(ACTThreadSelect)).apply(this, arguments));
	    }
	...
	var ForumReducer = exports.ForumReducer = (0, _redux.combineReducers)({
	    selectedSubforumID: function selectedSubforumID() {
	    ...
	    selectedThreadID: function selectedThreadID() {
	        var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
	        var action = arguments[1];
	...
	function GetSelectedSubforumID() {
	    return State("selectedSubforumID");
	}
	function GetSelectedSubforum() {
	    var selectedID = GetSelectedSubforumID();
	    return (0, _forum.GetSubforum)(selectedID);
	}
	function GetSelectedThreadID() {
	    return State("selectedThreadID");
	}
	function GetSelectedThread() {
	    var selectedID = GetSelectedThreadID();
	    return (0, _forum.GetThread)(selectedID);
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.GetSubforum = GetSubforum;
	exports.GetSubforums = GetSubforums;
	exports.GetSectionSubforums = GetSectionSubforums;
	...
	var _VCache = __webpack_require__(168);

	var _General = __webpack_require__(4);

	function GetSection(id) {
	    return (0, _DatabaseHelpers.GetData)("forum", "sections", id);
	}
	function GetSections() {
	    var sectionMap = (0, _DatabaseHelpers.GetData)("forum", "sections");
	    return (0, _VCache.CachedTransform)("GetSections", [], sectionMap, function () {
	        return sectionMap ? sectionMap.VValues(true) : [];
	    });
	}
	function GetSubforum(id) {
	    if (id == null) return null;
	    return (0, _DatabaseHelpers.GetData)("forum", "subforums", id);
	}
	function GetSubforums() {
	    var subforumMap = (0, _DatabaseHelpers.GetData)("forum", "subforums");
	    return (0, _VCache.CachedTransform)("GetSubforums", [], subforumMap, function () {
	        return subforumMap ? subforumMap.VValues(true) : [];
	    });
	}
	function GetSectionSubforums(section) {
	    ...
	    var subforums = (section.subforumOrder || []).map(function (id) {
	        return GetSubforum(id);
	    });
	    if (subforums.filter(function (a) {
	        return a == null;
	    }).length) return _General.emptyArray;
	    return (0, _VCache.CachedTransform)("GetSectionSubforums", [section._id], subforums, function () {
	        return subforums;
	    });
	}
	function GetThread(id) {
	    if (id == null) return null;
	    return (0, _DatabaseHelpers.GetData)("forum", "threads", id);
	}
	function GetThreads() {
	    var threadMap = (0, _DatabaseHelpers.GetData)("forum", "threads");
	    return (0, _VCache.CachedTransform)("GetThreads", [], threadMap, function () {
	...
	function GetPost(id) {
	    if (id == null) return null;
	    return (0, _DatabaseHelpers.GetData)("forum", "posts", id);
	}
	function GetPosts() {
	    var postsMap = (0, _DatabaseHelpers.GetData)("forum", "posts");
	    return (0, _VCache.CachedTransform)("GetPosts", [], postsMap, function () {
	        return postsMap ? postsMap.VValues(true) : [];
	    });
	}
	function GetThreadPosts(thread) {
	    var posts = thread.posts.map(function (id) {
	        return GetPost(id);
	    });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _FirebaseConnect = __webpack_require__(11);

	var _jsVextensions = __webpack_require__(5);

	var _reactVextensions = __webpack_require__(16);

	var _query = __webpack_require__(17);

	var _utils = __webpack_require__(156);

	var _StringSplitCache = __webpack_require__(167);
	...
	function DBPath() {
	    ...
	    (0, _jsVextensions.Assert)(path != null, "Path cannot be null.");
	    ...
	    if (inVersionRoot) path = _index.Manager.rootStorePath + "/" + path;
	    return path;
	}
	function DBPathSegments(pathSegments) {
	    ...
	    if (inVersionRoot) {
	        result = _index.Manager.rootStorePath.split("/").concat(result);
	    }
	    return result;
	}
	function SlicePath(path, removeFromEndCount) {
	    //let parts = path.split("/");
	    var parts = (0, _StringSplitCache.SplitStringBySlash_Cached)(path).slice();

	    for (var _len = arguments.length, itemsToAdd = Array(_len > 2 ? _len - 2 : 0), _key = 2; _key < _len; _key++) {
	        itemsToAdd[_key - 2] = arguments[_key];
	    }
	...
	function GetData() {
	    ...
	    return result;*/
	    return _index.Manager.GetData.apply(this, arguments);
	}

	var GetDataAsync_Options = exports.GetDataAsync_Options = function GetDataAsync_Options() {
	    _classCallCheck(this, GetDataAsync_Options);
	...
	function GetDataAsync() {
	    ...
	    return __awaiter(this, arguments, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
	        var _args = arguments;
	        return regeneratorRuntime.wrap(function _callee$(_context) {
	            while (1) {
	                switch (_context.prev = _context.next) {
	                    case 0:
	                        return _context.abrupt("return", _index.Manager.GetDataAsync.apply(this, _args));
	...
	function GetAsync(dbGetterFunc, statsLogger) {
	    return __awaiter(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
	        var firebase, result, requestedPathsSoFar, requestedPathsSoFar_last, newRequestedPaths, _iteratorNormalCompletion4, _didIteratorError4, _iteratorError4, _iterator4, _step4, path;

	        return regeneratorRuntime.wrap(function _callee2$(_context2) {
	            while (1) {
	                switch (_context2.prev = _context2.next) {
	                    case 0:
	                        (0, _jsVextensions.Assert)(!window["inConnectFunc"], "Cannot run GetAsync() from within a Connect() function.");
	                        //Assert(!g.inGetAsyncFunc, "Cannot run GetAsync() from within a GetAsync() function.");
	                        firebase = store.firebase;
	                        result = void 0;
	                        requestedPathsSoFar = {};
	                        requestedPathsSoFar_last = void 0;

	                    case 5:
	                        requestedPathsSoFar_last = Clone(requestedPathsSoFar);
	                        (0, _FirebaseConnect.ClearRequestedPaths)();
	                        result = dbGetterFunc();
	                        newRequestedPaths = (0, _FirebaseConnect.GetRequestedPaths)().Except(requestedPathsSoFar.VKeys());

	                        (0, _query.unWatchEvents)(firebase, store.dispatch, (0, _utils.getEventsFromInput)(newRequestedPaths)); // do this just to trigger re-get
	                        // start watching paths (causes paths to be requested)
	                        (0, _query.watchEvents)(firebase, store.dispatch, (0, _utils.getEventsFromInput)(newRequestedPaths));
	                        _iteratorNormalCompletion4 = true;
	                        _didIteratorError4 = false;
	                        _iteratorError4 = undefined;
	                        _context2.prev = 14;
	                        _iterator4 = newRequestedPaths[Symbol.iterator]();
	                    ...
	                    case 16:
	                        ...
	                        _context2.next = 21;
	                        return WaitTillPathDataIsReceived(path);
	                    ...
	                    case 38:
	                        if ((0, _reactVextensions.ShallowChanged)(requestedPathsSoFar, requestedPathsSoFar_last)) {
	                            _context2.next = 5;
	                            break;
	                        }
	        ...
	        }, _callee2, this, [[14, 26, 30, 38], [31,, 33, 37]]);
	    }));
	}
	function WaitTillPathDataIsReceived(path) {
	    return new Promise(function (resolve, reject) {
	        var pathDataReceived = State().firebase.requested[path];
	        ...
	        var listener = function listener() {
	            ...
	            pathDataReceived = State().firebase.requested[path];
	            if (pathDataReceived) {
	                unsubscribe();
	                resolve();
	            }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function Connect(funcOrFuncGetter) {
	    var mapStateToProps_inner = void 0,
	        mapStateToProps_inner_getter = void 0;
	    var isFuncGetter = funcOrFuncGetter.length == 0; //&& typeof TryCall(funcOrFuncGetter) == "function";
	    if (!isFuncGetter) mapStateToProps_inner = funcOrFuncGetter;else mapStateToProps_inner_getter = funcOrFuncGetter;
	    var mapStateToProps_wrapper = function mapStateToProps_wrapper(state, props) {
	        var s = this;
	        ...
	        if (s.lastAccessedStorePaths_withData == null) {
	            ...
	            for (var path in s.lastAccessedStorePaths_withData) {
	                if (State.apply(undefined, [{ countAsAccess: false }].concat(_toConsumableArray((0, _StringSplitCache.SplitStringBySlash_Cached)(path)))) !== s.lastAccessedStorePaths_withData[path]) {
	        ...
	        var propsChanged = (0, _reactVextensions.ShallowChanged)(props, s.lastProps || {}, "children");
	        ...
	        result._user = _Manager.Manager.GetUser(_Manager.Manager.GetUserID());
	        result._permissions = _Manager.Manager.GetUserPermissionGroups(_Manager.Manager.GetUserID());
	        ...
	        if ((0, _reactVextensions.ShallowChanged)(requestedPaths, oldRequestedPaths)) {
	            setImmediate(function () {
	                s._firebaseEvents = (0, _utils.getEventsFromInput)(requestedPaths);
	                var removedPaths = oldRequestedPaths.Except.apply(oldRequestedPaths, _toConsumableArray(requestedPaths));
	                ...
	                var addedPaths = requestedPaths.Except.apply(requestedPaths, _toConsumableArray(oldRequestedPaths));
	                (0, _query.watchEvents)(firebase, DispatchDBAction, (0, _utils.getEventsFromInput)(addedPaths));
	        ...
	        try {
	            for (var _iterator = accessedStorePaths[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                var _path = _step.value;

	                s.lastAccessedStorePaths_withData[_path] = State.apply(undefined, [{ countAsAccess: false }].concat(_toConsumableArray((0, _StringSplitCache.SplitStringBySlash_Cached)(_path))));
	            }
	        } catch (err) {
	            _didIteratorError = true;
	            _iteratorError = err;
	    ...
	    if (mapStateToProps_inner) return (0, _reactRedux.connect)(mapStateToProps_wrapper);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _forEach2 = __webpack_require__(18);

	var _forEach3 = _interopRequireDefault(_forEach2);

	var _constants = __webpack_require__(56);

	var _populate = __webpack_require__(57);

	var _query = __webpack_require__(155);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _set2 = __webpack_require__(101);
	...
	var _isObject2 = __webpack_require__(52);

	var _isObject3 = _interopRequireDefault(_isObject2);

	var _isArray2 = __webpack_require__(36);

	var _isArray3 = _interopRequireDefault(_isArray2);

	var _isString2 = __webpack_require__(152);

	var _isString3 = _interopRequireDefault(_isString2);

	var _filter2 = __webpack_require__(153);
	 ...
	 */
	var populateList = exports.populateList = function populateList(firebase, originalData, p, results) {
	  var mainChild = p.child.split('[]')[0];
	  var childParam = p.child.split('[]')[1];
	  return Promise.all((0, _map3.default)((0, _get3.default)(originalData, mainChild), function (id, childKey) {
	    // handle list of keys
	    ...
	    : populateKey).then(function (pc) {
	      if (pc) {
	        ...
	        // handle child param
	        return _defineProperty({}, childKey, (0, _set3.default)(id, childParam, Object.assign(pc, { key: (0, _get3.default)(id, childParam) })));
	      }
	      return results;
	    });
	  }));
	...
	var promisesForPopulate = exports.promisesForPopulate = function promisesForPopulate(firebase, originalData, populatesIn) {
	  ...
	  (0, _forEach3.default)(populates, function (p) {
	    ...
	    if ((0, _has3.default)(originalData, mainChild)) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var baseSet = __webpack_require__(102);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var assignValue = __webpack_require__(103),
	    castPath = __webpack_require__(61),
	    isIndex = __webpack_require__(40),
	    isObject = __webpack_require__(52),
	    toKey = __webpack_require__(100);
	...
	var unsetWatcher = exports.unsetWatcher = function unsetWatcher(firebase, dispatch, event, path) {
	  ...
	  if (firebase._.watchers[id] <= 1) {
	    ...
	    if (event !== 'first_child' && event !== 'once') {
	      ...
	      dispatch({ type: INIT_BY_PATH, path: path });
	    }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _remove2 = __webpack_require__(158);
	...
	var _flatMap2 = __webpack_require__(164);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var baseIteratee = __webpack_require__(109),
	    basePullAt = __webpack_require__(159);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var baseUnset = __webpack_require__(160),
	    isIndex = __webpack_require__(40);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var baseGet = __webpack_require__(107),
	    baseSlice = __webpack_require__(163);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reactVcomponents = __webpack_require__(175);

	var _reactVscrollview = __webpack_require__(176);

	var _SubforumUI = __webpack_require__(179);

	var _AddSectionDialog = __webpack_require__(192);

	var _AddSubforumDialog = __webpack_require__(195);

	var _ThreadUI = __webpack_require__(197);

	var _FirebaseConnect = __webpack_require__(11);

	var _forum = __webpack_require__(9);

	var _forum2 = __webpack_require__(6);
	    ...
	    _createClass(ForumUI, [{
	        ...
	        value: function render() {
	            var _props = this.props,
	                ...
	                selectedSubforum = _props.selectedSubforum,
	                selectedThread = _props.selectedThread;

	            if (selectedThread) {
	                return _react2.default.createElement(_ThreadUI.ThreadUI, { thread: selectedThread });
	            }
	            if (selectedSubforum) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function webpackUniversalModuleDefinition(root, factory) {
		if (( false ? 'undefined' : _typeof(exports)) === 'object' && ( false ? 'undefined' : _typeof(module)) === 'object') module.exports = factory(__webpack_require__(174), __webpack_require__(178));else if (true) !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(174), __webpack_require__(178)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));else {
			var a = (typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object' ? factory(require("react"), require("react-dom")) : factory(root["react"], root["react-dom"]);
			for (var i in a) {
				((typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object' ? exports : root)[i] = a[i];
			}
		}
	})(undefined, function (__WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_6__) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _SubforumDetailsUI = __webpack_require__(180);

	var _reactVscrollview = __webpack_require__(176);

	var _DeleteSubforum = __webpack_require__(181);

	var _AddThreadDialog = __webpack_require__(183);

	var _FirebaseConnect = __webpack_require__(11);

	var _forum = __webpack_require__(9);

	var _ThreadEntryUI = __webpack_require__(188);

	var _forum2 = __webpack_require__(6);

	var _Manager = __webpack_require__(2);

	var _UpdateSubforumDetails = __webpack_require__(190);

	var _DatabaseHelpers = __webpack_require__(10);

	var _reactVmessagebox = __webpack_require__(187);

	var _GlobalStyles = __webpack_require__(191);
	...
	var ActionBar_Left = function (_BaseComponent2) {
	    ...
	    function ActionBar_Left() {
	        ...
	        return _possibleConstructorReturn(this, (ActionBar_Left.__proto__ || Object.getPrototypeOf(ActionBar_Left)).apply(this, arguments));
	    }

	    _createClass(ActionBar_Left, [{
	        key: "render",
	        value: function render() {
	            var _props2 = this.props,
	                subforum = _props2.subforum,
	                subNavBarWidth = _props2.subNavBarWidth;

	            return _react2.default.createElement("nav", { style: {
	                    position: "absolute", zIndex: 1, left: 0, width: "calc(50% - " + subNavBarWidth / 2 + "px)", top: 0, textAlign: "center"
	                } }, _react2.default.createElement(_reactVcomponents.Row, { style: {
	                ...
	                } }), _react2.default.createElement(DetailsDropdown, { subforum: subforum })));
	        }
	    }]);
	    ...
	    _createClass(DetailsDropdown, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(_reactVcomponents.DropDown, null, _react2.default.createElement(_reactVcomponents.DropDownTrigger, null, _react2.default.createElement(_reactVcomponents.Button, { ml: 5, text: "Details" })), _react2.default.createElement(_reactVcomponents.DropDownContent, { style: { left: 0 } }, _react2.default.createElement(_reactVcomponents.Column, null, _react2.default.createElement(_SubforumDetailsUI.SubforumDetailsUI, { ref: function ref(c) {
	                ...
	                } })), isMod && _react2.default.createElement(_reactVcomponents.Column, { mt: 10 }, _react2.default.createElement(_reactVcomponents.Row, { style: { fontWeight: "bold" } }, "Advanced:"), _react2.default.createElement(_reactVcomponents.Row, null, _react2.default.createElement(_reactVcomponents.Button, { mt: 5, text: "Delete", onLeftClick: function onLeftClick() {
	                            ...
	                            while (1) {
	                                switch (_context3.prev = _context3.next) {
	                                    ...
	                                    case 2:
	                                        ...
	                                        return _context3.abrupt("return", void (0, _reactVmessagebox.ShowMessageBox)({ title: "Still has threads",
	...
	var ActionBar_Right = function (_BaseComponent4) {
	    ...
	    function ActionBar_Right() {
	        ...
	        return _possibleConstructorReturn(this, (ActionBar_Right.__proto__ || Object.getPrototypeOf(ActionBar_Right)).apply(this, arguments));
	    }

	    _createClass(ActionBar_Right, [{
	        key: "render",
	        value: function render() {
	            var _props3 = this.props,
	                subforum = _props3.subforum,
	                subNavBarWidth = _props3.subNavBarWidth,
	                initialChildLimit = _props3.initialChildLimit;

	            var tabBarWidth = 104;
	            return _react2.default.createElement("nav", { style: {
	                    position: "absolute", zIndex: 1, left: "calc(50% + " + subNavBarWidth / 2 + "px)", right: 0, top: 0, textAlign: "center"
	                } }, _react2.default.createElement(_reactVcomponents.Row, { style: {
	                    justifyContent: "flex-end", background: "rgba(0,0,0,.7)", boxShadow: _GlobalStyles.colors.navBarBoxShadow,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SubforumDetailsUI = exports.SubforumDetailsUI = function (_BaseComponent) {
	    ...
	    function SubforumDetailsUI() {
	        _classCallCheck(this, SubforumDetailsUI);

	        return _possibleConstructorReturn(this, (SubforumDetailsUI.__proto__ || Object.getPrototypeOf(SubforumDetailsUI)).apply(this, arguments));
	    }

	    _createClass(SubforumDetailsUI, [{
	        ...
	        value: function GetValidationError() {
	            return (0, _jsVextensions.GetErrorMessagesUnderElement)((0, _reactVextensions.FindDOM)(this))[0];
	        }
	    }, {
	        key: "GetNewData",
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Command2 = __webpack_require__(182);
	...
	var DeleteSubforum = exports.DeleteSubforum = function (_Command) {
	    ...
	    function DeleteSubforum() {
	        _classCallCheck(this, DeleteSubforum);

	        return _possibleConstructorReturn(this, (DeleteSubforum.__proto__ || Object.getPrototypeOf(DeleteSubforum)).apply(this, arguments));
	    }

	    _createClass(DeleteSubforum, [{
	        key: "Prepare",
	            ...
	            return __awaiter(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
	                ...
	                return regeneratorRuntime.wrap(function _callee$(_context) {
	                    while (1) {
	                        switch (_context.prev = _context.next) {
	                            case 0:
	                                subforumID = this.payload.subforumID;
	                                _context.next = 3;
	                                return (0, _DatabaseHelpers.GetDataAsync)({ addHelpers: false }, "forum", "subforums", subforumID);

	                            case 3:
	                                this.oldData = _context.sent;
	                                _context.next = 6;
	                                return (0, _DatabaseHelpers.GetDataAsync)("forum", "sections", this.oldData.section, "subforumOrder");
	        ...
	        value: function GetDBUpdates() {
	            var subforumID = this.payload.subforumID;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.Command = exports.CommandUserInfo = undefined;
	...
	var CommandUserInfo = exports.CommandUserInfo = function CommandUserInfo() {
	...
	function MergeDBUpdates(baseUpdatesMap, updatesToMergeMap) {
	    var baseUpdates = baseUpdatesMap.Props().map(function (prop) {
	        return { path: prop.name, data: prop.value };
	    });
	        ...
	        var _loop = function _loop() {
	            ...
	            try {
	                for (var _iterator6 = updatesToMergeIntoThisOne[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
	                    ...
	                    (0, _jsVextensions.DeepSet)(update.data, updateToMerge_relativePath, updateToMerge.data);
	                    /*} else {
	                        update.data = null;
	                    }*/
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.firstPostPlaceholderText = undefined;
	exports.ShowAddThreadDialog = ShowAddThreadDialog;
	...
	var _ThreadDetailsUI = __webpack_require__(184);

	var _Thread = __webpack_require__(172);

	var _AddThread = __webpack_require__(185);
	...
	var firstPostPlaceholderText = exports.firstPostPlaceholderText = "*Press the Edit button below to write the text for your thread's first post.*";
	function ShowAddThreadDialog(userID, subforumID) {
	    var _this = this;
	                    ...
	                    while (1) {
	                        switch (_context.prev = _context.next) {
	                            ...
	                            case 2:
	                                ...
	                                store.dispatch(new _forum.ACTThreadSelect({ id: threadID }));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ThreadDetailsUI = exports.ThreadDetailsUI = function (_BaseComponent) {
	    ...
	    function ThreadDetailsUI() {
	        _classCallCheck(this, ThreadDetailsUI);

	        return _possibleConstructorReturn(this, (ThreadDetailsUI.__proto__ || Object.getPrototypeOf(ThreadDetailsUI)).apply(this, arguments));
	    }

	    _createClass(ThreadDetailsUI, [{
	        key: "ComponentWillMountOrReceiveProps",
	        value: function ComponentWillMountOrReceiveProps(props, forMount) {
	            if (forMount || props.baseData != this.props.baseData) {
	                this.SetState({ newData: Clone(props.baseData) });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _AddPost = __webpack_require__(186);
	...
	var AddThread = exports.AddThread = function (_Command) {
	    ...
	    function AddThread() {
	        _classCallCheck(this, AddThread);

	        return _possibleConstructorReturn(this, (AddThread.__proto__ || Object.getPrototypeOf(AddThread)).apply(this, arguments));
	    }

	    _createClass(AddThread, [{
	        key: "Prepare",
	        value: function Prepare() {
	            return __awaiter(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
	                var _payload, thread, post, lastThreadID;
	                    ...
	                    while (1) {
	                        switch (_context.prev = _context.next) {
	                            case 0:
	                                ...
	                                _context.next = 3;
	                                return (0, _DatabaseHelpers.GetDataAsync)("forum", "general", "lastThreadID");
	            ...
	            return __awaiter(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
	                ...
	                return regeneratorRuntime.wrap(function _callee2$(_context2) {
	                    while (1) {
	                        switch (_context2.prev = _context2.next) {
	                            case 0:
	                                thread = this.payload.thread;

	                                AssertValidate("Thread", thread, "Thread invalid");
	                                _context2.next = 4;
	                                return this.sub_addPost.Validate();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var AddPost = exports.AddPost = function (_Command) {
	    ...
	    _createClass(AddPost, [{
	        ...
	        value: function Prepare() {
	            return __awaiter(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
	                var _payload2, threadID, post, firebase, lastPostID;
	                    ...
	                    while (1) {
	                        switch (_context.prev = _context.next) {
	                            case 0:
	                                ...
	                                _context.next = 4;
	                                return (0, _DatabaseHelpers.GetDataAsync)("forum", "general", "lastPostID");
	                            ...
	                            case 4:
	                                ...
	                                _context.next = 11;
	                                return (0, _DatabaseHelpers.GetDataAsync)("forum", "threads", threadID, "posts");
	                            ...
	                            case 14:
	                                this.thread_oldPosts = _context.t0;
	        ...
	        key: "GetDBUpdates",
	        value: function GetDBUpdates() {
	            var _payload3 = this.payload,
	                threadID = _payload3.threadID,
	                post = _payload3.post;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Link = function (_BaseComponent) {
	    ...
	    _createClass(Link, [{
	        ...
	        value: function handleClick(event) {
	            ...
	            if (actions) {
	                ...
	                var isExternal = _jsVextensions.VURL.Parse(to, true).domain != GetCurrentURL().domain;
	                if (isExternal || target) return; // let browser handle external links, and "target=_blank"
	                event.preventDefault();
	                store.dispatch(replaceURL ? _Manager.Manager.router_replace(to) : _Manager.Manager.router_push(to));
	            }
	        }
	    }, {
	        key: "render",
	        value: function render() {
	            var _a = this.props,
	                ...
	                actions = _a.actions,
	                children = _a.children,
	                rest = __rest(_a, ["text", "to", "target", "actions", "children"]); // eslint-disable-line no-unused-vars
	            ...
	            if (to) {
	                return _react2.default.createElement("a", Object.assign({}, rest, { onClick: this.handleClick, href: to, target: target }), text, children);
	            }
	        }
	    }]);
	...
	exports.Link = Link = __decorate([(0, _FirebaseConnect.Connect)(function (state, _ref) {
	    ...
	    if (actions) {
	        ...
	        try {
	            for (var _iterator = actionsToDispatch[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                var action = _step.value;

	                newState = _Manager.Manager.rootReducer(newState, action);
	            }
	        } catch (err) {
	            _didIteratorError = true;
	            _iteratorError = err;
	        ...
	        _Manager.Manager.State_overrides.state = newState;
	        _Manager.Manager.State_overrides.countAsAccess = false;
	        var newURL = _Manager.Manager.GetNewURL();
	        _Manager.Manager.State_overrides.countAsAccess = null;
	        _Manager.Manager.State_overrides.state = null;
	        to = newURL.toString();
	    }
	    return {
	...
	function GetCurrentURL() {
	    var fromAddressBar = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;

	    //return fromAddressBar ? VURL.Parse(GetCurrentURLString()) : VURL.FromState(State("router"));
	    return fromAddressBar ? _jsVextensions.VURL.Parse((0, _jsVextensions.GetCurrentURLString)()) : _jsVextensions.VURL.FromState(State("router"));
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	AddSchema({
	    properties: {
	        ...
	        subforumUpdates: Schema({
	            properties: {
	                name: { type: "string", pattern: _Subforum.Subforum_nameFormat }
	            }
	        })
	    },
	...
	var UpdateSubforumDetails = exports.UpdateSubforumDetails = function (_Command) {
	    ...
	    function UpdateSubforumDetails() {
	        _classCallCheck(this, UpdateSubforumDetails);

	        return _possibleConstructorReturn(this, (UpdateSubforumDetails.__proto__ || Object.getPrototypeOf(UpdateSubforumDetails)).apply(this, arguments));
	    }

	    _createClass(UpdateSubforumDetails, [{
	        key: "Validate_Early",
	        value: function Validate_Early() {
	        ...
	        value: function Prepare() {
	            return __awaiter(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
	                var _payload, subforumID, subforumUpdates;

	                return regeneratorRuntime.wrap(function _callee$(_context) {
	                    while (1) {
	                        switch (_context.prev = _context.next) {
	                            case 0:
	                                _payload = this.payload, subforumID = _payload.subforumID, subforumUpdates = _payload.subforumUpdates;
	                                _context.next = 3;
	                                return (0, _DatabaseHelpers.GetDataAsync)({ addHelpers: false }, "forum", "subforums", subforumID);
	                            ...
	                            case 3:
	                                ...
	                                this.newData = Object.assign({}, this.oldData, subforumUpdates);
	        ...
	        value: function GetDBUpdates() {
	            var _payload2 = this.payload,
	                subforumID = _payload2.subforumID,
	                subforumUpdates = _payload2.subforumUpdates;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.ShowAddSectionDialog = ShowAddSectionDialog;
	...
	var _SectionDetailsUI = __webpack_require__(193);

	var _AddSection = __webpack_require__(194);
	...
	function ShowAddSectionDialog(userID) {
	    var newSection = new _Section.Section({
	        name: ""
	    });
	    var detailsUI = void 0;
	    var error = null;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var AddSection = exports.AddSection = function (_Command) {
	    ...
	    _createClass(AddSection, [{
	        ...
	        value: function Prepare() {
	            return __awaiter(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
	                var section, firebase, lastSectionID;
	                return regeneratorRuntime.wrap(function _callee$(_context) {
	                    while (1) {
	                        switch (_context.prev = _context.next) {
	                            case 0:
	                                ...
	                                firebase = store.firebase.helpers;
	                                _context.next = 4;
	                                return (0, _DatabaseHelpers.GetDataAsync)("forum", "general", "lastSectionID");
	                            ...
	                            case 4:
	                                ...
	                                _context.next = 8;
	                                return (0, _DatabaseHelpers.GetDataAsync)("forum", "general", "sectionOrder");
	                            ...
	                            case 11:
	                                this.oldSectionOrder = _context.t0;
	        ...
	        key: "GetDBUpdates",
	        value: function GetDBUpdates() {
	            var section = this.payload.section;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.ShowAddSubforumDialog = ShowAddSubforumDialog;
	...
	var _AddSubforum = __webpack_require__(196);
	...
	function ShowAddSubforumDialog(userID, sectionID) {
	    var newSubforum = new _Subforum.Subforum({
	        name: ""
	    });
	    var detailsUI = void 0;
	    var error = null;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var AddSubforum = exports.AddSubforum = function (_Command) {
	    ...
	    function AddSubforum() {
	        _classCallCheck(this, AddSubforum);

	        return _possibleConstructorReturn(this, (AddSubforum.__proto__ || Object.getPrototypeOf(AddSubforum)).apply(this, arguments));
	    }

	    _createClass(AddSubforum, [{
	        key: "Prepare",
	        value: function Prepare() {
	            return __awaiter(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
	                var _payload, sectionID, subforum, firebase, lastSubforumID;
	                    ...
	                    while (1) {
	                        switch (_context.prev = _context.next) {
	                            case 0:
	                                ...
	                                firebase = store.firebase.helpers;
	                                _context.next = 4;
	                                return (0, _DatabaseHelpers.GetDataAsync)("forum", "general", "lastSubforumID");
	                            ...
	                            case 4:
	                                ...
	                                _context.next = 9;
	                                return (0, _DatabaseHelpers.GetDataAsync)("forum", "sections", sectionID, "subforumOrder");
	                            ...
	                            case 12:
	                                this.oldSubforumOrder = _context.t0;
	            ...
	            return __awaiter(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
	                ...
	                return regeneratorRuntime.wrap(function _callee2$(_context2) {
	                    while (1) {
	                        switch (_context2.prev = _context2.next) {
	                            case 0:
	                                subforum = this.payload.subforum;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _PostUI = __webpack_require__(198);

	var _ThreadDetailsUI = __webpack_require__(184);

	var _UpdateThreadDetails = __webpack_require__(219);

	var _PostEditorUI = __webpack_require__(199);
	...
	var _DeleteThread = __webpack_require__(220);
	    ...
	    _createClass(ReplyBox, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(_reactVcomponents.Column, { sel: true, mt: 20, style: { background: "rgba(0,0,0,.7)", borderRadius: 10, padding: 10, alignItems: "flex-start", cursor: "auto" } }, _react2.default.createElement(_PostEditorUI.PostEditorUI, { ref: function ref(c) {
	                ...
	                } }), _react2.default.createElement(_reactVcomponents.Row, { mt: 5 }, _react2.default.createElement(_reactVcomponents.Button, { text: "Post reply", enabled: dataError == null, onLeftClick: function onLeftClick() {
	    ...
	    _createClass(ActionBar_Left, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement("nav", { style: {
	                ...
	                } }), _react2.default.createElement(DetailsDropdown, { thread: thread })));
	        }
	    }]);
	    ...
	    _createClass(DetailsDropdown, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(_reactVcomponents.DropDown, null, _react2.default.createElement(_reactVcomponents.DropDownTrigger, null, _react2.default.createElement(_reactVcomponents.Button, { ml: 5, text: "Details" })), _react2.default.createElement(_reactVcomponents.DropDownContent, { style: { left: 0 } }, _react2.default.createElement(_reactVcomponents.Column, null, _react2.default.createElement(_ThreadDetailsUI.ThreadDetailsUI, { ref: function ref(c) {
	                ...
	                } }), _react2.default.createElement(_reactVcomponents.Pre, { ml: 10, style: { opacity: .7 } }, "(note: threads with responses by others cannot be deleted)"))))));
	        }
	    }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _DeletePost = __webpack_require__(217);

	var _UpdatePost = __webpack_require__(218);
	...
	var VReactMarkdown_Remarkable = _Manager.Manager.MarkdownRenderer;
	        ...
	        value: function render() {
	            ...
	            if (editing) {
	                return _react2.default.createElement(_reactVcomponents.Column, { sel: true, mt: index != 0 ? 20 : 0, style: { flexShrink: 0, background: "rgba(0,0,0,.7)", borderRadius: 10, padding: 10, alignItems: "flex-start", cursor: "auto" } }, _react2.default.createElement(_PostEditorUI.PostEditorUI, { ref: function ref(c) {
	                        ...
	                        return __awaiter(_this2, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
	                            ...
	                            return regeneratorRuntime.wrap(function _callee$(_context) {
	                                while (1) {
	                                    switch (_context.prev = _context.next) {
	                                        case 0:
	                                            postUpdates = (0, _DatabaseHelpers.GetUpdates)(post, this.postEditorUI.GetNewData());
	                                            _context.next = 3;
	                                            return new _UpdatePost.UpdatePost({ postID: post._id, postUpdates: postUpdates }).Run();
	                    ...
	                    } }), _react2.default.createElement(_reactVcomponents.Button, { ml: 5, text: "Cancel", onLeftClick: function onLeftClick() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _MarkdownToolbar = __webpack_require__(200);

	var _reactMdEditor = __webpack_require__(209);
	...
	var PostEditorUI = exports.PostEditorUI = function (_BaseComponent) {
	    ...
	    function PostEditorUI() {
	        _classCallCheck(this, PostEditorUI);

	        return _possibleConstructorReturn(this, (PostEditorUI.__proto__ || Object.getPrototypeOf(PostEditorUI)).apply(this, arguments));
	    }

	    _createClass(PostEditorUI, [{
	        key: "ComponentWillMountOrReceiveProps",
	        value: function ComponentWillMountOrReceiveProps(props, forMount) {
	            if (forMount || props.baseData != this.props.baseData) this.SetState({ newData: Clone(props.baseData) });
	        }
	    }, {
	        key: "render",
	        value: function render() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Formatter = __webpack_require__(208);
	...
	var MarkdownToolbar = exports.MarkdownToolbar = function (_BaseComponent) {
	    ...
	    _createClass(MarkdownToolbar, [{
	        ...
	        value: function render() {
	            ...
	            var commands = [{ name: "h1", label: "H1" }, { name: "h2", label: "H2" }, { name: "h3", label: "H3" }, { name: "h4", label: "H4" }, { name: "bold", label: "b" }, { name: "italic", label: "i" }, { name: "oList", label: "ol" }, { name: "uList", label: "ul" }, { name: "quote", label: "q" }];
	            return _react2.default.createElement(_reactVcomponents.Row, { mt: 3, mb: 3 }, commands.filter(function (a) {
	                return !excludeCommands.Contains(a.name);
	    ...
	    _createClass(ToolBarButton, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(_reactVcomponents.Button, Object.assign({}, rest, { width: 24, height: 24, ml: first ? 0 : 5,
	                ...
	                } }), icon ? _react2.default.createElement("span", { dangerouslySetInnerHTML: { __html: icon }, className: "MDEditor_toolbarButton_icon", style: { position: "relative" } }) : label);
	        }
	    }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
		bold: __webpack_require__(202),
		italic: __webpack_require__(203),
		link: __webpack_require__(204),
		uList: __webpack_require__(205),
		oList: __webpack_require__(206),
...
/***/ (function(module, exports) {
	...
	var FORMATS = {
	    ...
	    h4: { type: 'block', token: 'header-4', before: '####', re: /^####\s+/, placeholder: 'Heading' },
	    bold: { type: 'inline', token: 'strong', before: '**', after: '**', placeholder: 'bold text' },
	    italic: { type: 'inline', token: 'em', before: '*', after: '*', placeholder: 'italic text' },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function(mod) {
	  if (true) // CommonJS
	    mod(__webpack_require__(212), __webpack_require__(213), __webpack_require__(215));
	  else if (typeof define == "function" && define.amd) // AMD
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var DeletePost = exports.DeletePost = function (_Command) {
	    ...
	    function DeletePost() {
	        ...
	        return _possibleConstructorReturn(this, (DeletePost.__proto__ || Object.getPrototypeOf(DeletePost)).apply(this, arguments));
	    }
	    ...
	    _createClass(DeletePost, [{
	                    ...
	                    while (1) {
	                        switch (_context.prev = _context.next) {
	                            case 0:
	                                ...
	                                _context.next = 3;
	                                return (0, _DatabaseHelpers.GetAsync)(function () {
	                                    return (0, _forum.GetPost)(postID);
	                                });
	                            ...
	                            case 3:
	                                ...
	                                _context.next = 6;
	                                return (0, _DatabaseHelpers.GetAsync)(function () {
	                                    return (0, _forum.GetThread)(_this2.oldData.thread);
	                                });
	        ...
	        key: "GetDBUpdates",
	        value: function GetDBUpdates() {
	            var postID = this.payload.postID;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var UpdatePost = exports.UpdatePost = function (_Command) {
	    _inherits(UpdatePost, _Command);

	    function UpdatePost() {
	        _classCallCheck(this, UpdatePost);

	        return _possibleConstructorReturn(this, (UpdatePost.__proto__ || Object.getPrototypeOf(UpdatePost)).apply(this, arguments));
	    }
	    ...
	    _createClass(UpdatePost, [{
	        ...
	        value: function Prepare() {
	            return __awaiter(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
	                var _payload, postID, postUpdates;

	                return regeneratorRuntime.wrap(function _callee$(_context) {
	                    while (1) {
	                        switch (_context.prev = _context.next) {
	                            case 0:
	                                _payload = this.payload, postID = _payload.postID, postUpdates = _payload.postUpdates;
	                                _context.next = 3;
	                                return (0, _DatabaseHelpers.GetDataAsync)({ addHelpers: false }, "forum", "posts", postID);

	                            case 3:
	                                this.oldData = _context.sent;

	                                this.newData = Object.assign({}, this.oldData, postUpdates);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var UpdateThreadDetails = exports.UpdateThreadDetails = function (_Command) {
	    ...
	    function UpdateThreadDetails() {
	        _classCallCheck(this, UpdateThreadDetails);

	        return _possibleConstructorReturn(this, (UpdateThreadDetails.__proto__ || Object.getPrototypeOf(UpdateThreadDetails)).apply(this, arguments));
	    }

	    _createClass(UpdateThreadDetails, [{
	        key: "Validate_Early",
	        value: function Validate_Early() {
	        ...
	        value: function Prepare() {
	            return __awaiter(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
	                var _payload, threadID, threadUpdates;

	                return regeneratorRuntime.wrap(function _callee$(_context) {
	                    while (1) {
	                        switch (_context.prev = _context.next) {
	                            case 0:
	                                _payload = this.payload, threadID = _payload.threadID, threadUpdates = _payload.threadUpdates;
	                                _context.next = 3;
	                                return (0, _DatabaseHelpers.GetDataAsync)({ addHelpers: false }, "forum", "threads", threadID);

	                            case 3:
	                                this.oldData = _context.sent;

	                                this.newData = Object.assign({}, this.oldData, threadUpdates);
	        ...
	        value: function GetDBUpdates() {
	            var _payload2 = this.payload,
	                threadID = _payload2.threadID,
	                threadUpdates = _payload2.threadUpdates;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var DeleteThread = exports.DeleteThread = function (_Command) {
	    ...
	    function DeleteThread() {
	        _classCallCheck(this, DeleteThread);

	        return _possibleConstructorReturn(this, (DeleteThread.__proto__ || Object.getPrototypeOf(DeleteThread)).apply(this, arguments));
	    }

	    _createClass(DeleteThread, [{
	        key: "Prepare",
	        value: function Prepare() {
	            return __awaiter(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
	                var threadID, thread;
	                    ...
	                    while (1) {
	                        switch (_context.prev = _context.next) {
	                            case 0:
	                                ...
	                                _context.next = 3;
	                                return (0, _DatabaseHelpers.GetAsync)(function () {
	                                    return (0, _forum.GetThread)(threadID);
	                                });
	                            ...
	                            case 3:
	                                ...
	                                _context.next = 6;
	                                return (0, _DatabaseHelpers.GetAsync)(function () {
	                                    return (0, _forum.GetThreadPosts)(thread);
	                                });
	            ...
	            return __awaiter(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
	                ...
	                return regeneratorRuntime.wrap(function _callee2$(_context2) {
	                    while (1) {
	                        switch (_context2.prev = _context2.next) {
	                            case 0:
	                                if (!this.posts.filter(function (a) {
	                                    return a.creator != _this2.userInfo.id && a.text;
	                                }).length) {
	                                    _context2.next = 2;
	                                    break;
	                                }
	        ...
	        key: "GetDBUpdates",
	        value: function GetDBUpdates() {
	            var threadID = this.payload.threadID;
